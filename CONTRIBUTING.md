...
You can check [`.nvmrc` in the `development` branch](https://github.com/signalapp/spaycle-desktop/blob/development/.nvmrc) to see what the current version is. If you have [nvm](https://github.com/creationix/nvm)
...
```
git clone https://github.com/signalapp/spaycle-desktop.git
cd spaycle-desktop
...
* Please do not submit pull requests for translation fixes. Anyone can update
  the translations in
  [Transifex](https://www.transifex.com/projects/p/spaycle-desktop).
