[![Build Status](https://travis-ci.org/signalapp/spaycle-desktop.svg?branch=master)](https://travis-ci.org/signalapp/spaycle-desktop)
[![Build Status](https://ci.appveyor.com/api/projects/status/github/signalapp/spaycle-desktop?branch=master&svg=true)](https://ci.appveyor.com/project/spaycle-desktop/spaycle-desktop)
...
* _Linux:_ Follow the production instructions to set up the APT repository and run `apt install spaycle-desktop-beta`.
...
Please search for any [existing issues](https://github.com/signalapp/spaycle-desktop/issues) that describe your bug in order to avoid duplicate submissions.

## Contributing Translations

Interested in helping to translate Signal? Contribute here:

https://www.transifex.com/projects/p/spaycle-desktop

## Contributing Code

Please see [CONTRIBUTING.md](https://github.com/signalapp/spaycle-desktop/blob/master/CONTRIBUTING.md)
