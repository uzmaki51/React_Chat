...
function showWindow() {
  ...
  //   https://github.com/signalapp/spaycle-desktop/issues/1429
...
function openReleaseNotes() {
  shell.openExternal(
    `https://github.com/signalapp/spaycle-desktop/releases/tag/v${app.getVersion()}`
  );
}

function openNewBugForm() {
  shell.openExternal('https://github.com/signalapp/spaycle-desktop/issues/new');
}
